...
class BackgroundsStyle(Style):
    ...
    BackGroundGreenStyleImage = PhotoImage
    BackGroundGrayAppStyleImage = PhotoImage
    ...
    def __init__(self,master=None):
        ...
        self.BackGroundGrayAppStyleImage = PhotoImage("backGroundGrayAppImage",data="""""")
